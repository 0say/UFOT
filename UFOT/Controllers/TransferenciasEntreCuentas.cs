...
{
    public class TransferenciasEntreCuentasController : BaseController
    {
        public TransferenciasEntreCuentasController(LogService logger, BancoWebContext context, INotyfService notyf, HttpClient httpClient) : base(logger, context, notyf, httpClient)
        {
        }
